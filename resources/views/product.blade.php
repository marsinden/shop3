    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li ><a href="/basket">Your cart</a></li>
                <li><a href="/reset">Reset project to default state</a></li>
...
<div class="container">
    ...
    <p>Отличный продвинутый телефон с памятью на 64 gb</p>
            ...
            <input type="hidden" name="_token" value="IBq6cteAhrnGX1BqW7vB412QSzpan3Xy7rXepUDD">        </form>
        </div>
</div>
</body>
</html>
